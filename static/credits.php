	...
	<div class="banner _credits" style="background-image: url('/static/theme/images/banners/credits.png');">
		<div class="grid__inner">
			<div class="banner__inner">
					<div class="banner__title">Кредиты</div>
			</div>
		</div>
	</div>
	...
	<div class="credits">
		<div class="grid__inner">
			...
			<div class="b-block credits__item">
				...
				<div class="card__options">
					<div class="card__option">
						<div class="card__option-val">600 000 ₽</div>
						<div class="card__option-title">
							Максимальная сумма
						</div>
					</div>
					<div class="card__option">
						<div class="card__option-val"><span>от</span> 8,5%</div>
						<div class="card__option-title">
							Гарантированная ставка
						</div>
					</div>
			...
			<div class="b-block credits__item">
				...
				<div class="card__options">
					<div class="card__option">
						<div class="card__option-val">150 000 ₽</div>
						<div class="card__option-title">
							Максимальная сумма
						</div>
					</div>
			...
			<div class="b-block credits__item">
				...
				<div class="card__options">
					<div class="card__option">
						<div class="card__option-val">2 000 000 ₽</div>
						<div class="card__option-title">
							Максимальная сумма
						</div>
					</div>
			...
			<div class="b-block credits__item">
				...
				<div class="card__options">
					<div class="card__option">
						<div class="card__option-val">300 000 ₽</div>
						<div class="card__option-title">
							Максимальная сумма
						</div>
					</div>
					<div class="card__option">
						<div class="card__option-val"><span>от</span> 0,0%</div>
						<div class="card__option-title">
