<div class="anketa__step">
	<div class="clearfix">
		<div class="anketa__form">
				...
				<div class="b-form__row hide" data-check-toggle-content="car">
					...
					<div class="b-form__row">
						<div class="b-form__block" data-form-field>
							<div class="b-form__field" data-autocomplete>
								<input type="text" data-form-field-inp data-autocomplete-inp>
								<div class="b-form__placeholder">Модель</div>
								<?include "autocomplate.php"?>
							</div>
							<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
						</div>
					...
					<div class="b-form__row">
						<div class="b-form__block" data-form-field>
							<div class="b-form__field">
								<input type="text" data-form-field-inp data-year-mask>
								<div class="b-form__placeholder">Год</div>
							</div>
							<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
						</div>
					</div>
			...
			<div class="anketa__form-block">
				<div class="b-block__title h4 _dash anketa__form-block-title">Страховой номер</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__field">
			...
			<div class="anketa__form-block">
				<div class="b-block__title h4 _dash anketa__form-block-title">Активные кредиты</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__field">
							<select data-chosen  data-required>
							...
							<div class="b-form__placeholder">Кредиты наличными</div>
						</div>
						<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__field">
							...
							<div class="b-form__placeholder">Кредитные карты</div>
						</div>
						<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__field">
							...
							<div class="b-form__placeholder">Ипотека</div>
						</div>
						<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__field">
							...
							<div class="b-form__placeholder">Суммарный платеж по всем кредитам</div>
						</div>
						<div class="b-form__error">Были допущены ошибки или поле оставлено пустым.</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__label">У вас есть просрочки по кредиту?</div>
						<div class="b-form__radio">
							<label class="b-form__radio-btn _w50"><input type="radio" name="name1" checked><span class="b-form__radio-text">Нет</span></label>
							<label class="b-form__radio-btn _w50"><input type="radio" name="name1"><span class="b-form__radio-text">Да</span></label>
						</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__label">У вас были просрочки более 3 месяцев?</div>
						<div class="b-form__radio">
							<label class="b-form__radio-btn _w50"><input type="radio" name="name2" checked><span class="b-form__radio-text">Нет</span></label>
							<label class="b-form__radio-btn _w50"><input type="radio" name="name2"><span class="b-form__radio-text">Да</span></label>
						</div>
					</div>
				</div>
				<div class="b-form__row">
					<div class="b-form__block" data-form-field>
						<div class="b-form__label">Вы брали кредиты за последний месяц?</div>
						<div class="b-form__radio">
							<label class="b-form__radio-btn _w50"><input type="radio" name="name3" checked><span class="b-form__radio-text">Нет</span></label>
							<label class="b-form__radio-btn _w50"><input type="radio" name="name3"><span class="b-form__radio-text">Да</span></label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="anketa__form-block anketa__form-bottom">
				<div class="anketa__form-bottom-in">
					...
					<div class="anketa__form-bottom-btns">
						...
						<a href="javascript:void(0);" class="anketa__form-bottom-btn btn" data-anketa-goto-btn="5">Отправить заявку</a>
					</div>
				</div>
			</div>
		</div>
