<div class="anketa__step">
	<div class="anketa__info">
		<div class="anketa__title">
			<div class="banner__title">Заявка на кредитную карту</div>
		</div>
				...
				<div class="conditions__all-files files">
					<a href="#" class="file">
						...
						<div class="file__inner">
							<div class="file__name">Тариф по кредитной карте «Элемент 120»<br/>
								(действует с 24.01.17)</div>
					...
					<a href="#" class="file">
						...
						<div class="file__inner">
							<div class="file__name">Тариф по кредитной карте «Элемент 120»<br /> (для зарплатных клиентов, действует с 10.03.17)</div>
					...
					<div class="credit-calc__option" data-credit-calc-option>
						...
						<div class="credit-calc__option-block">
							<div class="credit-calc__option-field">
								...
								<input type="text" value="250 000" data-credit-calc-option-inp data-credit-calc-sum>
							</div>
		...
		<div class="anketa__aside">
			<div class="b-steps anketa__aside-steps _vertical _arrs">
				...
				<div class="b-steps__item">
					...
					<div class="b-steps__item-text">Заявка будет рассмотрена<br/> в течение минуты.</div>
				</div>
				<div class="b-steps__item">
					<div class="b-steps__item-ico" style="background-image: url('/static/theme/images/icons/instruction/3.svg')"></div>
					<div class="b-steps__item-title">3. Получите карту</div>
