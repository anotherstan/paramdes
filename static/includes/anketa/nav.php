<div class="anketa__nav">
	<div class="anketa__nav-inner grid__inner">
		...
		<div class="anketa__nav-steps" data-anketa-nav>
			...
			<a href="javascript:void(0);" class="anketa__nav-step" data-anketa-nav-step="2">
				<div class="anketa__nav-step-num">Шаг 2</div>
				<div class="anketa__nav-step-title">Основное</div>
			</a>
			<a href="javascript:void(0);" class="anketa__nav-step" data-anketa-nav-step="3">
				<div class="anketa__nav-step-num">Шаг 3</div>
				<div class="anketa__nav-step-title">Паспорт</div>
			</a>
			<a href="javascript:void(0);" class="anketa__nav-step" data-anketa-nav-step="4">
				<div class="anketa__nav-step-num">Шаг 4</div>
				<div class="anketa__nav-step-title">Работа</div>
			</a>
			<a href="javascript:void(0);" class="anketa__nav-step" data-anketa-nav-step="5">
